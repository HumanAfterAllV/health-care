/**
 * @HumanAfterAllV
 * @TODO - Change the color modal to a custom color picker
 */
            ...
            {modalOptions && (
                <Dialog open={isOpen} onOpenChange={closeModal}>
                    <DialogContent className="shad-dialog sm:max-w-md">
                        ...
                        <DialogFooter>
                            <Button className="bg-green-400 hover:bg-green-400 text-dark-800" onClick={() => {modalOptions.onConfirm(); closeModal();}}>Confirm</Button>
                            {modalOptions.onCancel && (
                                <Button className="bg-red-500 hover:bg-red-500 text-white" onClick={() => {modalOptions.onCancel(); closeModal();}}>Cancel</Button>
                            )}
                        </DialogFooter>
                    </DialogContent>
                </Dialog>
