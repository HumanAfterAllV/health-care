...
export default function RegisterForm({user}: {user: User }): JSX.Element {
  ...
  async function onSubmit(values: z.infer<typeof PatientFormValidation>) {
    ...
    return(
        <div ref={elementRef} className="sub-container max-w-[860px] flex-1 flex-col py-10">
            <Logo />
            <Form {...form}>
                <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-12 flex-1">
                    <section className="space-y-4 animate-item animate-item">
                        <h1 className="header">Welcome</h1>
                        <p className="text-dark-700">Let us know more about yourself.</p>
                    </section>
                    <section className="space-y-6 animate-item">
                    ...
                    <div className="flex flex-col gap-6 xl:flex-row animate-item">
                        <CustomFormField
                            fieldType={FormFieldTypes.INPUT}
                            control={form.control}
                            name="email"
                    ...
                    >
                        {Doctors.map((doctor) => (
                            <SelectItem key={doctor.name} value={doctor.name} className="hover:bg-green-200">
                    ...
                    <div className="flex flex-col gap-6 xl:flex-row animate-item">
                        ...
                        >
                            {BloodTypes.map((type) => (
                                <SelectItem value={type} key={type} className="flex cursor-pointer hover:bg-green-200">
                                    {type}
                                </SelectItem>
                            ))}
                        </CustomFormField>
                    ...
                    <div className="flex flex-col gap-6 xl:flex-row animate-item">
                        ...
                        >
                            {IdentificationTypes.map((type) => (
                                <SelectItem key={type} value={type} className="cursor-pointer hover:bg-green-200">
                                    {type}
                                </SelectItem>
                            ))}
                        </CustomFormField>
